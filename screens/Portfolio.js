...
function Portfolio({portfolioTotalBalance, stock1Balance, stock2Balance, stock3Balance, stock4Balance, stock1Shares, stock2Shares, stock3Shares, stock4Shares, navigation}) {
        ...
        <View style={styles.backdrop}>
            <ImageBackground source={require('../assets/bgimage.png')} style={styles.image}>
                <ScrollView contentContainerStyle={styles.container3}>
                    ...
                    <Image source={require("../assets/chart.png")} style={{width: '100%', height: undefined, aspectRatio: 1.936507936507937}} resizeMode='cover'/>
                    ...
                    <View style={{flexDirection: 'column', width: '90%', margin: 10}}>
                        ...
                        <Pressable
                            ...
                            onPress={() => navigation.navigate('Stocks', {stockName: stock1Name, stockBalance: stock1Balance, stockDirection: stock1Ticker, value: 156.57, shares: stock1Shares, marketCap: 2.555, marketCapScale: 'T', change: 0.15, volume: 87.51, volumeScale: 'M', avgVolume: 87.69, avgVolumeScale: 'M', portfolioTotalBalance: portfolioTotalBalance})}>
                        ...
                        <Pressable
                            ...
                            onPress={() => navigation.navigate('Stocks', {stockName: stock2Name, stockBalance: stock2Balance, stockDirection: stock2Ticker, value: 10.60, shares: stock2Shares, marketCap: 1.437, marketCapScale: 'B', change: 6.43, volume: 205.15, volumeScale: 'K', avgVolume: 860.91, avgVolumeScale: 'K', portfolioTotalBalance: portfolioTotalBalance})}>
                        ...
                        <Pressable
                            ...
                            onPress={() => navigation.navigate('Stocks', {stockName: stock3Name, stockBalance: stock3Balance, stockDirection: stock3Ticker, value: 11.23, shares: stock3Shares, marketCap: 3.602, marketCapScale: 'B', change: 2.94, volume: 15.99, volumeScale: 'M', avgVolume: 10.50, avgVolumeScale: 'M', portfolioTotalBalance: portfolioTotalBalance})}>
                            <View style={{flexDirection: 'row', width: '85%'}}>
                                <View style={{flex: 1.1, flexDirection: 'column', alignself: 'baseline'}}>
                        ...
                        <Pressable
                            ...
                            onPress={() => navigation.navigate('Stocks', {stockName: stock4Name, stockBalance: stock4Balance, stockDirection: stock4Ticker, value: 31.22, shares: stock4Shares, marketCap: 27.58, marketCapScale: 'B', change: 1.76, volume: 15.09, volumeScale: 'M', avgVolume: 18.22, avgVolumeScale: 'M', portfolioTotalBalance: portfolioTotalBalance})}>
